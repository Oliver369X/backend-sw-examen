...
exports.expertImageToSpringBoot = void 0;
const expertBase_1 = require("./expertBase");
const generative_ai_1 = require("@google/generative-ai");
const expertSpringBootTemplate_1 = require("./expertSpringBootTemplate");
exports.expertImageToSpringBoot = (0, expertBase_1.createExpert)({
...
Analiza esta imagen de diagrama UML y genera el JSON estructurado EXACTO:`;
            ...
            const { UMLParser } = await Promise.resolve().then(() => __importStar(require('../utils/umlParser')));
            ...
            const zipBuffer = await expertSpringBootTemplate_1.expertSpringBootTemplate.process({
