...
async function testECommerceGenerator() {
    ...
    try {
        ...
        const umlData = umlParser_1.UMLParser.parseDiagram(ecommerceUMLDiagram);
        ...
        const outputPath = path_1.default.join(__dirname, '../temp/ecommerce-app.zip');
        ...
        const extractPath = path_1.default.join(__dirname, '../temp/ecommerce-app');
        // Limpiar directorio de extracción si existe
        if (await fs_extra_1.default.pathExists(extractPath)) {
            await fs_extra_1.default.remove(extractPath);
