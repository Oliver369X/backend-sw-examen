...
interface DiagramGeneratorInput {
  prompt: string;
  style?: 'class' | 'sequence' | 'activity';
}

interface DiagramGeneratorOutput {
  diagramData: {
    classes: any[];
    interfaces: any[];
    relationships: any[];
...
export const expertDiagramGenerator = createExpert({
...
RESPONDE SOLO CON EL JSON, SIN EXPLICACIONES ADICIONALES.`,
  ...
  async process(input: DiagramGeneratorInput): Promise<DiagramGeneratorOutput> {
