...
import { GoogleGenerativeAI, GenerationConfig as GeminiGenerationConfig, HarmCategory, HarmBlockThreshold } from '@google/generative-ai';

// Interfaz para la entrada del experto
interface UMLToSpringBootInput {
...
export const expertUMLToSpringBoot = createExpert({
...
Genera código limpio, funcional y siguiendo las mejores prácticas de Spring Boot.`,
  ...
  async process(input: UMLToSpringBootInput) {
